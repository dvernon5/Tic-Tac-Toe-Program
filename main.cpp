...
bool checkIfWinnerAcross(const char[][ROWS_AND_COLUMNS], const char, string &);

bool checkIfWinnerDown(const char[][ROWS_AND_COLUMNS], const char, string &);

bool checkIfWinnerDiagonalLeftToRight(const char[][ROWS_AND_COLUMNS], const char, string &);

bool checkIfWinnerDiagonalRightToLeft(const char[][ROWS_AND_COLUMNS], const char, string &);

bool checkForWinner(const char[][ROWS_AND_COLUMNS], const char, string &);
...
void player(char array[][ROWS_AND_COLUMNS], char letter)
{
    ...
    do
    {
        ...
        if (array[(row -1)][(column - 1)] == '*')
        {
            ...
            elementOccupied = true;
        }
        else
        {
            cout << "Sorry, that spot is taken." << endl;
            elementOccupied = false;
        }
        
    } while (elementOccupied == false);
}
...
bool checkForWinner(const char array[][ROWS_AND_COLUMNS], const char letter, string &game_winner)
{
    bool winner = false;
...
bool checkIfWinnerAcross(const char array[][ROWS_AND_COLUMNS], const char letter, string &game_winner)
{
    int letter_across = 0;
    bool winner = false;
...
bool checkIfWinnerDown(const char array[][ROWS_AND_COLUMNS], const char letter, string &game_winner)
{
    int letter_down = 0;
    bool winner = false;
...
bool checkIfWinnerDiagonalLeftToRight(const char array[][ROWS_AND_COLUMNS], const char letter, string &game_winner)
{
...
bool checkIfWinnerDiagonalRightToLeft(const char array[][ROWS_AND_COLUMNS], const char letter, string &game_winner)
{
    int letter_diagonal = 0;
    bool winner;
